...
public class Tests {
    ...
    public void testProblem37() throws Exception {
        ...
        Assert.assertEquals(true, EulerProblems
                .isTruncatablePrime(3797, primes));
        Assert.assertEquals(false, EulerProblems.isTruncatablePrime(5, primes));
        Assert.assertEquals(748317, EulerProblems.problem37());
    }
